...
{
    public Image menu_bar, main_bg, menu_bttn, basic_menu, main_bg_dark, cart_page;
    public RawImage product;
    public GameObject main_page, cart_scrollview;
    public Image mypage;
    public GameObject[] product_page;
